...
{	
	...
	string in_img = "AM-1-00248.jpg";
	Mat testImg = imread("../../data/"+ in_img, 0);
	...
	Mat lineImg = testEDLines.drawOnImage();	//draws on the input image，修改了EDLines.cpp对应函数以便彩色显示结果

	imwrite(in_img+".EDLines.jpg", lineImg);
